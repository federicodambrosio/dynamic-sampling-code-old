//
// Test code for the reverse CascadeOfGroups Class
//
...
int main(){
	...
	const std::string outx = "revcog-x.txt";
	const std::string outU = "revcog-uni.txt";
	const std::string outb1 = "revcog-b1.txt";
	const std::string outb2 = "revcog-b2.txt";
	const std::string outb3 = "revcog-b3.txt";
	...
	for (double NExp = 1; NExp <= maxNExp; NExp+=deltaN){
		...
		for (unsigned long RExp = 1; RExp <= minRExp; RExp+=deltaR){
			...
			for (unsigned long i = 0; i < runs; i++){
				...
				CascadeOfGroups cog(true,min,1.,2.);
